      ...
      <div className="bg-school-yellow overflow-hidden py-2 relative flex items-center justify-center">
        <div className="animate-[marquee_20s_linear_infinite] whitespace-nowrap text-school-black font-semibold text-xs sm:text-sm md:text-base px-4">
          {settings?.marqueeText ||
            "Admissions Open 2026-27 | Free School Books & Bags 🎒"}{" "}
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{" "}
          {settings?.marqueeText ||
            "Admissions Open 2026-27 | Free School Books & Bags 🎒"}
        </div>
          ...
          <ScrollReveal delay={0.1}>
            <div className="flex flex-col space-y-6 max-w-xl">
              <h1 className="font-heading font-extrabold tracking-tight text-slate-900">
                Join the Fun,{" "}
                <span className="text-school-blue">Learn with Love</span>
              </h1>
              <p className="text-lg md:text-xl text-slate-600 font-sans">
                Where every child's potential is nurtured with care, creativity,
                and a structured curriculum designed for the future.
              </p>
          ...
          <ScrollReveal delay={0.3}>
            <div className="relative mx-auto aspect-video w-full max-w-lg lg:max-w-none lg:w-[600px] rounded-3xl border-4 border-school-red shadow-2xl overflow-hidden">
              {settings?.heroImages && settings.heroImages.length > 0 ? (
                <ImageSlideshow
                  images={settings.heroImages.map((url: string, i: number) => ({
                    id: `hero-${i}`,
                    url,
                  }))}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <Card className="border-none shadow-md hover:shadow-xl transition-shadow bg-white text-center h-full">
                ...
                <CardContent>
                  <p className="text-slate-600">
                    We focus on extracurriculars like Karate, Music, and Arts
                    alongside academics to nurture a well-rounded personality.
                  </p>
                </CardContent>
              </Card>
            </ScrollReveal>
            ...
            <ScrollReveal delay={0.2}>
              <Card className="border-none shadow-md hover:shadow-xl transition-shadow bg-white text-center h-full">
                ...
                <CardContent>
                  <p className="text-slate-600">
                    Equipped with modern computer labs and interactive digital
                    whiteboards to make learning engaging and future-ready.
                  </p>
                </CardContent>
              </Card>
            </ScrollReveal>
            ...
            <ScrollReveal delay={0.3}>
              <Card className="border-none shadow-md hover:shadow-xl transition-shadow bg-white text-center h-full">
                ...
                <CardContent>
                  <p className="text-slate-600">
                    24/7 CCTV surveillance and secure campus boundaries ensuring
                    your child's complete safety at all times.
                  </p>
                </CardContent>
              </Card>
            </ScrollReveal>
            ...
            <ScrollReveal delay={0.1}>
              <div className="relative aspect-video rounded-3xl overflow-hidden bg-slate-100 shadow-xl">
                {settings?.aboutImages && settings.aboutImages.length > 0 ? (
                  <ImageSlideshow
                    images={settings.aboutImages.map(
                      (url: string, i: number) => ({ id: `about-${i}`, url }),
                    )}
                  />
                ) : (
                  <Image
            ...
            <ScrollReveal delay={0.2}>
              <div className="space-y-6">
                ...
                <p className="text-lg text-slate-600 leading-relaxed">
                  Established with a singular goal to create a nurturing
                  educational environment, Paradise English School and Tender
                  Kidz Pre-School empower young minds to thrive intellectually,
        ...
        <div className="container">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <p className="mt-6 text-lg text-slate-600">
              A seamless educational journey from the very first days of
            ...
            <ScrollReveal delay={0.1}>
              <Link href="/tender-kidz" className="block group h-full">
                <div className="bg-white rounded-3xl p-8 border-2 border-transparent group-hover:border-school-yellow transition-all shadow-md group-hover:shadow-xl h-full flex flex-col">
                  <div className="w-16 h-16 bg-school-yellow/20 rounded-2xl flex items-center justify-center mb-6 text-3xl">
                    🧸
                  </div>
                  <h3 className="text-2xl font-heading font-bold text-slate-900 mb-4 group-hover:text-school-yellow transition-colors">
                    Tender Kidz Pre-School
                  </h3>
                  <p className="text-slate-600 mb-6 flex-1">
                    Playgroup, Nursery, and Kindergarten. A vibrant, play-based
                    environment focusing on early childhood development and
                    foundational learning.
                  </p>
                  <div className="font-bold text-school-yellow flex items-center gap-2">
                    Explore Tender Kidz &rarr;
                  </div>
                </div>
              </Link>
            </ScrollReveal>
            ...
            <ScrollReveal delay={0.2}>
              <Link href="/academics" className="block group h-full">
                <div className="bg-white rounded-3xl p-8 border-2 border-transparent group-hover:border-school-blue transition-all shadow-md group-hover:shadow-xl h-full flex flex-col">
                  <div className="w-16 h-16 bg-school-blue/10 rounded-2xl flex items-center justify-center mb-6 text-3xl">
                    📚
                  </div>
                  <h3 className="text-2xl font-heading font-bold text-slate-900 mb-4 group-hover:text-school-blue transition-colors">
                    Paradise English School
                  </h3>
                  <p className="text-slate-600 mb-6 flex-1">
                    Primary and beyond. A structured curriculum blending
                    traditional values with modern educational methodologies.
                  </p>
                  <div className="font-bold text-school-blue flex items-center gap-2">
                    Explore Primary &rarr;
                  </div>
                </div>
              </Link>
            </ScrollReveal>
        ...
        <div className="container">
          <div className="bg-white rounded-3xl p-8 md:p-12 shadow-md border border-slate-100 flex flex-col lg:flex-row gap-10 items-center">
            ...
            <div className="lg:w-2/3 space-y-4 text-center lg:text-left">
              ...
              <p className="text-lg text-slate-600 leading-relaxed">
                We believe education is a collaborative journey. Regular
                Parent-Teacher Meetings (PTMs), interactive workshops, and
                family events ensure that parents are actively engaged in their
      ...
      <Section className="bg-white">
        <div className="container">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12">
            ...
            <Link
              href="/notices"
              className="text-school-blue font-medium hover:underline mt-4 md:mt-0"
            >
                  ...
                  >
                    <Card className="h-full border-l-4 border-l-school-blue hover:shadow-lg transition-shadow">
                      <CardHeader>
                        ...
                        <CardTitle className="font-heading text-lg leading-tight group-hover:text-school-blue transition-colors">
                          {notice.title}
                        </CardTitle>
                      </CardHeader>
                      <CardContent>
        ...
        <Section className="bg-slate-50">
          <div className="container">
            ...
            <div className="text-center">
              <Link
                href="/faq"
                className="inline-flex h-12 items-center justify-center rounded-full bg-white border border-slate-200 px-8 font-bold text-slate-700 shadow-sm transition-colors hover:bg-slate-50"
              >
                View All FAQs
              </Link>
            </div>
