...
export function FileUploadField({ value, onChange, label, description }: FileUploadFieldProps) {
          ...
          <div className="relative inline-block border rounded-lg overflow-hidden bg-slate-50">
            <div className="relative w-48 h-48 sm:w-64 sm:h-64 flex items-center justify-center bg-slate-100">
              {value.match(/\.(mp4|webm)(\?.*)?$/i) ? (
                ...
                <iframe src={`${value}#toolbar=0`} className="w-full h-full" title="PDF Preview" />
                ...
                <div className="flex flex-col items-center justify-center space-y-2 p-4 text-center">
                  ...
                  <span className="text-sm text-slate-600 font-medium">Document File</span>
                </div>
              ) : (
                ...
                <img 
                  ...
                  onError={(e) => {
                    (e.target as HTMLImageElement).src = "https://placehold.co/400x400?text=Invalid+File+URL";
                  }}
                />
              )}
            </div>
            ...
            <div className="flex border-b bg-slate-50">
              <button
                ...
                className={`flex-1 py-2 text-sm font-medium flex items-center justify-center transition-colors ${
                  mode === "upload" ? "bg-white border-b-2 border-school-blue text-school-blue" : "text-slate-500 hover:text-slate-700"
                }`}
              ...
              <button
                type="button"
                className={`flex-1 py-2 text-sm font-medium flex items-center justify-center transition-colors ${
                  mode === "link" ? "bg-white border-b-2 border-school-blue text-school-blue" : "text-slate-500 hover:text-slate-700"
                }`}
            ...
            <div className="p-4">
              {mode === "upload" ? (
                ...
                >
                  ...
                  {isUploading ? (
                    ...
                    <>
                      ...
                      <p className="text-sm font-medium text-slate-700 mb-1">Select File</p>
                    </>
                  )}
                ...
                <div className="flex space-x-2">
                  ...
                  />
                  <Button type="button" onClick={handleAddLink} disabled={!tempLink.trim()}>
                    Add
                  </Button>
                </div>
              )}
